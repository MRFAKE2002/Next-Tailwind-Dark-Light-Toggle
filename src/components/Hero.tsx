...
function Hero() {
  return (
    <div className="isolate">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16">
            ...
            <div className="flex-1 space-y-6 lg:space-y-7">
              ...
              <div className="space-y-4 lg:space-y-5">
                ...
                <h1 className="text-4xl md:5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight text-neutral-900 dark:text-white">
                ...
                <p className="text-base lg:text-lg text-neutral-700 dark:text-neutral-300 max-w-2xl font-light">
                  ...
                  powered by the latest Tailwind CSS. Create stunning user
              ...
              <div className="flex flex-wrap gap-3 lg:gap-4">
                <button className="px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-900 hover:bg-black text-white dark:bg-amber-500 dark:hover:bg-amber-600 dark:text-emerald-900 font-medium shadow-lg hover:shadow-neutral-900/20 dark:hover:shadow-amber-500/20 flex items-center transition group">
                  <i className="bx bx-code-alt mr-2 lg:mr-3 text-lg lg:text-xl group-hover:rotate-12 transition-transform"></i>
                  <span>Start Coding</span>
                </button>
                <button className="px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-100 hover:bg-neutral-200 dark:hover:bg-neutral-700 dark:bg-neutral-800 text-neutral-900 dark:text-white border border-neutral-300 dark:border-neutral-700 font-medium flex items-center transition group">
                  <i className="bx bx-book-open mr-2 lg:mr-3 text-lg lg:text-xl group-hover:opacity-100 opacity-70 transition-opacity"></i>
              ...
              <div className="relative">
                ...
                <div className="relative bg-white dark:bg-neutral-900 p-4 lg:p-5 xl:p-6 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800 ">
                  ...
                  <div className="mt-3 lg:mt-4 flex justify-between items-center">
                    ...
                    {/* Copy Button */}
                    <button className="w-8 h-8 lg:w-9 lg:h-8 xl:w-10 xl:h-10 flex items-center justify-center rounded-full bg-amber-500 text-neutral-900 hover:bg-amber-600 transition">
      ...
      {/* Bouncing Badges Buttons */}
      <div className="hidden md:block absolute bottom-8 left-8 lg:bottom-10 lg:left-10 animate-bounce">
        <div className="bg-neutral-900 text-white px-2.5 py-1.5 rounded-full text-xm lg:text-sm flex items-center shadow-lg">
